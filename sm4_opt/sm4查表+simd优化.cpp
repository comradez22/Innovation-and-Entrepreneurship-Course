...
string fk0 = "10100011101100011011101011000110";
string fk1 = "01010110101010100011001101010000";
string fk2 = "01100111011111011001000110010111";
string fk3 = "10110010011100000010001011011100";
bitset<32> FK0(fk0);
bitset<32> FK1(fk1);
bitset<32> FK2(fk2);
bitset<32> FK3(fk3);
static uint32_t FK[4] = { 0xa3b1bac6, 0x56aa3350, 0x677d9197, 0xb27022dc };
const long CKI[32] = { 0x00070e15,0x1c232a31,0x383f464d,0x545b6269,
